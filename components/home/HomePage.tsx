          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8">
            ...
            <div className="flex-1 text-center md:text-left order-2 md:order-1">
              <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4 md:mb-6 leading-tight">
                Welcome to <span className="text-blue-400">Praja Poll Analytics</span>
              </h1>
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-slate-300 max-w-full md:max-w-3xl leading-relaxed">
